...
{
    public class AdmissionsInTheLastMonth
    {
        /// <summary>
        /// Take Attendances and Patients and creates Attendances in the last month.
        /// </summary>
        /// <param name="Attendances"></param>
        /// <param name="Patients"></param>
        /// <param name="OrganisationCode"></param>
        /// <returns></returns>
        public IList<ModelLastMonthAttendances> ReturnAdmissionsInTheLastMonth(IContext Context, String OrganisationCode)
        {
            var admissions = (from a in Context.Attendances
                join p in Context.Patients
                    on a.NHSNo equals p.NHSNo
                where a.AttendanceDisposal == "1"
