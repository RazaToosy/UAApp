...
{
    public class DischargeWorkSheet : IWorkSheet<ModelLastMonthsDischarges>
    {
        ...
        public DischargeWorkSheet(Workbook WorkBook, String TitleOfWorkSheet)
        {
            _workBook = WorkBook;
        ...
        public void PopulateWorkSheet(List<ModelLastMonthsDischarges> entities)
        {
           ...
           worksheet.Cells[1, 8].SetValue("Type of Admission");
           worksheet.Cells[1, 9].SetValue("Discharge Ward");
           worksheet.Cells[1, 10].SetValue("Discharge Speciality");
           worksheet.Cells[1, 11].SetValue("Admission Date");
           worksheet.Cells[1, 12].SetValue("Discharge Date");
           worksheet.Cells[1, 13].SetValue("Is Dead");
           ...
           worksheet.Columns[13].SetWidth(new ColumnWidth(100, true));
            ...
            entities.ForEach(e =>
            {
                ...
                worksheet.Cells[currentRow, 8].SetValue(e.TypeOfAdmission);
                worksheet.Cells[currentRow, 9].SetValue(e.DischargeWard);
                worksheet.Cells[currentRow, 10].SetValue(e.DischargeSpeciality);
                worksheet.Cells[currentRow, 11].SetValue(e.AdmissionDate.ToShortDateString());
                worksheet.Cells[currentRow, 12].SetValue(e.DischargeDate.ToShortDateString());
                worksheet.Cells[currentRow, 13].SetValue(e.DishDeceasedFlag);
